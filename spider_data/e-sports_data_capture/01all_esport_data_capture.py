...
def esprot_data_capture():
    ...
    # 全部 雷速体育
    url = "https://app-gateway.leisu.com/v1/app/match/esports/lol/match_live?auth_key=1605245993-0-0-d08ca7d3a17d328ca50ea4bb9a728315"
    header = {
        "sn": "003dca5d",
    ...
    for base_count in range(int(len(base_result["data"]["matches"]))):
        ...
        url_chat = "https://app-gateway.leisu.com/v1/app/chat/history?room_id=R4_1_" + str(
            match_id) + "&auth_key=1605246041-0-0-698081ccb8b5e2112408a1542f0c25fb"
        header_chat = {
            "sn": "003dca5d",
            "device_id": "1507bfd3f77dfd86703",
            "aid": "c20964cf79411c67",
        ...
        url_data = "https://app-gateway.leisu.com/v1/app/match/esports/lol/match_analysis?match_id=" + str(
            match_id) + "&auth_key=1605246041-0-0-9cf95415eb9a8afa48c0e28f5a2b1360"
        header_data = {
            "sn": "003dca5d",
            "device_id": "1507bfd3f77dfd86703",
            "aid": "c20964cf79411c67",
        ...
        with open("q_" + str(match_id) + ".txt", "w", encoding="utf-8") as f:
            f.write(base1)
