...
def esprot_data_capture():
    ...
    for j in range(7):
        i = i + 1
        print(i)
        url = "https://app-gateway.leisu.com/v1/app/match/esports/lol/match_list?date=202011"+str(i)+"&n=1&auth_key=1605236387-0-0-8c9156525bc213f1c39521c1064f94b3"
        header = {
            "sn": "003dca5d",
        ...
        for base_count in range(int(len(base_result["data"]["matches"]))):
            ...
            # print(base)
            # match_id
            url_chat = "https://app-gateway.leisu.com/v1/app/chat/history?room_id=R4_1_"+str(match_id)+"&auth_key=1605236428-0-0-3202854cf0a138408d06686328082d3b"
            header_chat = {
                "sn": "003dca5d",
                "device_id": "1507bfd3f77dfd86703",
                "aid": "c20964cf79411c67",
            ...
            url_data = "https://app-gateway.leisu.com/v1/app/match/esports/lol/match_analysis?match_id="+str(match_id)+"&auth_key=1605236429-0-0-e805b72a336b83a9212f93d97da892a7"
            header_data = {
                "sn": "003dca5d",
                "device_id": "1507bfd3f77dfd86703",
                "aid": "c20964cf79411c67",
            ...
            with open("sc_" + str(i) + "_" + str(match_id) + ".txt", "w", encoding="utf-8") as f:
                f.write(base1)
