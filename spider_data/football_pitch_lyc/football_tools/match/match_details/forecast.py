...
from football_pitch_lyc.football_tools.match.Teamid_return_list import teamid_return_list
import time
...
if __name__ == '__main__':
    ...
    index_failed = "/opt/data_captureAPP/football_pitch_lyc/football_tools/match/match_details/index_failed.txt"
    index = 0
