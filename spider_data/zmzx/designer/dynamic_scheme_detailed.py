...
def dynamic_scheme_detailed(design_case_id):
    ...
    # if int(result["collect_count"]) != 0:
        ...
        house_image_info_list = []
        if "house_image_info_list" in result:
...
if __name__ == '__main__':
    # dynamic_scheme_detailed(4732)
    # dynamic_scheme_detailed(2123)
    dynamic_scheme_detailed(2795)
